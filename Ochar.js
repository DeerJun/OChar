...
(OrgChart.prototype._constructor = function (t) {
            ...
            if (!n.notifierUI.show(t.notif)) {
              ...
              for (d = 0; d < t.visibleNodeIds.length; d++) {
                ...
                OrgChart.RENDER_LINKS_BEFORE_NODES ||
                  ...
                  (o += n.ui.expandCollapseBtn(n, g, n._layoutConfigs, e, s));
              }
              a = { content: o, res: t };
              if (
                ...
                (e !== OrgChart.action.centernode &&
                  ...
                  (n.response = t);
                x = n.ui.svg(n.width(), n.height(), h, n.config, o);
                if (n._initialized) {
                  var u = n.getSvg(),
                    f = u.parentNode;
                  f.removeChild(u),
                  ...
                  (n.element.innerHTML =
                    ...
                    n.undoRedoUI.init(n);
                var m = !1,
                  C = n.response.animations;
                if (C[0].length > 0) {
                  n._hideBeforeAnimation(C[0].length);
                  for (d = 0; d < C[0].length; d++)
                    C[0][d] = n.getNodeElement(C[0][d]);
                  OrgChart.animate(
                    C[0],
                    C[1],
                    C[2],
                ...
                var b = t.boundary,
                  v = b.maxX - b.minX,
                  O = b.maxY - b.minY,
                  x = n.ui.svg(v, O, [b.minX, b.minY, v, O], n.config, o, s);
                i(x, t);
              }
            }
          },
  ...
  (OrgChart.prototype.ripple = function (t, e, r) {
    ...
    if (null != i) {
      ...
      if (null != n) {
        ...
        OrgChart.events.publish("ripple", [this, v]),
  ...
  (OrgChart.prototype.moveNodesToVisibleArea = function (t, e) {
    for (
      ...
      var c = this.nodes[t[h]];
      (null === a || a < c.x + c.w) && (a = c.x + c.w),
    ...
    var d = this.width(),
      g = this.height(),
      p = d / (b = a - s + 2 * this.config.padding),
      u = g / (v = o - l + 2 * this.config.padding),
      f = p > u ? u : p,
      m = Math.ceil(d / f),
      C = Math.ceil(g / f),
      b = 0,
      v = 0;
    if (m - 2 * this.config.padding >= a - s) b = (a + s) / 2 - m / 2;
    else
      switch (
        ((b =
          firstRoot.x -
        ...
        case OrgChart.orientation.right_top:
          (b = -(m / 2 - (s - a) / 2)) < this.config.padding - m &&
            (b = this.config.padding - m);
          break;
        ...
        case OrgChart.orientation.left_top:
          (b = -(m / 2 - (a - s) / 2)) > -this.config.padding &&
            (b = -this.config.padding);
      }
    if (C - 2 * this.config.padding >= o - l) v = (o + l) / 2 - C / 2;
    else
      switch (
        ((v = -(C / 2 - (o - l) / 2)) > -this.config.padding &&
          (v = -this.config.padding),
        this.config.orientation)
      ) {
        case OrgChart.orientation.bottom:
        case OrgChart.orientation.bottom_left:
          (v = -(C / 2 - (l - o) / 2)) < this.config.padding - C &&
            (v = this.config.padding - C);
          break;
        case OrgChart.orientation.left:
        case OrgChart.orientation.right:
          v =
  ...
  (OrgChart.prototype.removeNode = function (t, e, r) {
    ...
    var n = this._getNewPidsAndStpidsForIds(t);
    if (!0 === r && !1 === OrgChart.events.publish("remove", [this, t, n]))
      return !1;
    return (
      this.remove(t),
      this._ai.setContext(),
  ...
  (OrgChart.animate = function (t, e, r, i, n, a, o) {
    ...
    return (
      ...
      (s = setInterval(function () {
              ...
              case "rotate3d":
                if (r[d][g]) {
                  var C = e[d][g],
                    ...
                    v = [0, 0, 0, 0];
                  for (var O in C)
                    v[O] = n((h * l - l) / i) * (b[O] - C[O]) + C[O];
                  t[d].style.transform = "rotate3d(" + v.toString() + "deg)";
                }
                break;
              case "transform":
                if (r[d][g]) {
                  (C = e[d][g]), (b = r[d][g]), (v = [0, 0, 0, 0, 0, 0]);
                  for (var O in C)
                    v[O] = n((h * l - l) / i) * (b[O] - C[O]) + C[O];
                  t[d].hasAttribute("transform")
                    ...
                    : (t[d].style.transform = "matrix(" + v.toString() + ")");
                }
                break;
              case "viewbox":
                if (r[d][g]) {
                  (C = e[d][g]), (b = r[d][g]), (v = [0, 0, 0, 0]);
                  for (var O in C)
                    v[O] = n((h * l - l) / i) * (b[O] - C[O]) + C[O];
                  t[d].setAttribute("viewBox", v.toString());
                }
                break;
              case "margin":
                if (r[d][g]) {
                  ...
                  for (var O in C)
                    v[O] = n((h * l - l) / i) * (b[O] - C[O]) + C[O];
                  var x = "";
                  for (O = 0; O < v.length; O++) x += parseInt(v[O]) + "px ";
        ...
        o && o(), (h += 1) > c + 1 && (clearInterval(s), a && a(t));
      }, l))
    );
  }),
  (OrgChart.anim = {}),
  ...
  (OrgChart.prototype._addEvent = function (t, e, r, i) {
    ...
    t.getListenerList[e + i]) ||
      ...
      (a = r),
      (r = function () {
        if (a) return a.apply(n, [this, arguments[0]]);
      }),
      t.addEventListener
        ? "mousewheel" == e || "wheel" == e
  ...
  (OrgChart.editUI.prototype.show = function (t, e, r) {
    ...
    this.obj.element.appendChild(n.element),
      ...
      this.obj.element
        ...
        .addEventListener("click", function (e) {
          e.preventDefault();
          var r = OrgChart.input.validateAndGetData(n.element);
          if (!1 !== r) {
            var a = i.obj.get(t),
              o = { data: OrgChart.mergeDeep(a, r) };
          ...
          n.nextElementSibling.addEventListener("click", function (t) {
            ...
            var r = n.value,
              a = i.obj.element.querySelector(
                '[data-binding="' + OrgChart._escapeDoubleQuotes(n.value) + '"]'
              );
          ...
          if (r && r.hasAttribute) {
            ...
            switch (a) {
              case "edit":
                ...
                break;
              case "pdf":
                i.obj.exportPDFProfile({ id: t, filename: n.title }), i.hide();
                break;
              case "png":
                i.obj.exportPNGProfile({ id: t, filename: n.title }), i.hide();
                break;
              case "share":
  ...
  (OrgChart.editUI.prototype.content = function (t, e, r, i, n) {
    ...
    if (this.obj.config.editForm.generateElementsFromFields)
      for (var v = 0; v < this.fields.length; v++) {
        var O = this.fields[v];
        if ("tags" != O) {
          for (var x = !1, y = 0; y < s.length; y++) {
            if (Array.isArray(s[y])) {
              for (var _ = 0; _ < s[y].length; _++)
                if (O == s[y][_].binding) {
                  x = !0;
                  break;
                }
            } else if (O == s[y].binding) {
              x = !0;
              break;
            }
            if (x) break;
          }
          x || s.push({ type: "textbox", label: O, binding: O });
        }
      }
    OrgChart.isNEU(C) && (C = ""),
      (b = OrgChart.isNEU(b)
        ? OrgChart.icon.user(150, 150, "#8C8C8C", 0, 0)
        : `<img style="width: 100%;height:100%;border-radius: 50%;object-fit:cover;" src="${b}"></img>`);
    var k = !e,
      w = e ? "display:none;" : "",
      S = e || !l ? "display:none;" : "",
    ...
    if (
      ...
      for (v = 0; v < u.tags.length; v++)
        A.classList.add(u.tags[v].replaceAll(" ", ""));
    ...
    return (
        ...
        for (var t = "", r = 0; r < s.length; r++) {
          ...
          if (Array.isArray(i)) {
            ...
            for (var n = 0; n < i.length; n++) {
              var o = i[n],
                l = OrgChart.elements[o.type](f, o, "unset", e);
              !OrgChart.isNEU(l.id) &&
                OrgChart.isNEU(a) &&
            ...
            l = OrgChart.elements[i.type](f, i, "280px", e);
            !OrgChart.isNEU(l.id) &&
              OrgChart.isNEU(a) &&
              OrgChart.isNEU(l.value) &&
              (a = l.id),
      ...
      { element: A, focusId: a, title: C, shareText: L.join("\n") }
    );
  }),
    ...
    if ("" != o) {
      ...
      for (
        ...
        (l = u[f]).addEventListener("click", function (t) {
          ...
          if (void 0 === n[o].onClick)
            if ("add" === o) {
              var s = { id: a.obj.generateId(), pid: r };
              a.obj.addNode(s, null, !0);
            } else if ("edit" === o) {
              var l = a.obj.getNode(r);
              a.obj.editUI.show(l.id);
            } else if ("details" === o) {
              l = a.obj.getNode(r);
              a.obj.editUI.show(l.id, !0);
            } else
              "remove" === o
                ? a.obj.removeNode(r, null, !0)
                : "svg" === o
                ? a.obj.exportSVG({
                ...
                : "csv" === o
                ? a.obj.exportCSV({ nodeId: r })
                : "xml" === o
                ? a.obj.exportXML({ nodeId: r })
                : "json" === o
                ? a.obj.exportJSON({ nodeId: r })
                : "visio" === o && a.obj.exportVisio({ nodeId: r });
          else e = n[o].onClick.call(a.obj, r, i);
          0 != e && a.hide();
        });
      }
    }
      ...
      if (
        ...
        for (
          var m = 0,
            ...
            v = 2 * Math.PI * b,
            O = v / C - (2 * n.nodeCircleMenuButton.radius + 2);
          O < 0;
        ...
        u.menu)) {
          ...
          w.setAttribute("transform", "matrix(1,0,0,1,0,0)"),
            w.setAttribute(OrgChart.attr.control_node_circle_menu_name, x),
            (w.style.cursor = "pointer");
          var S = document.createElementNS(
            "http://www.w3.org/2000/svg",
            "title"
          );
          OrgChart.isNEU(k) || (S.innerHTML = k);
          ...
          I.setAttribute("cx", 0),
            I.setAttribute("cy", 0),
            I.setAttribute("r", n.nodeCircleMenuButton.radius),
            I.setAttribute("fill", _),
            I.setAttribute("stroke-width", "1"),
            I.setAttribute("stroke", n.nodeCircleMenuButton.stroke),
            w.appendChild(I),
            w.appendChild(S),
            (w.innerHTML += y),
            p.appendChild(w);
          var A = w.getElementsByTagName("svg")[0];
  ...
  (OrgChart._exportPDFFromChartsFetchWithCallback = function (t, e) {
    t.type && "profile" == t.type.toLowerCase()
      ? t.chartInstance.exportPDFProfile(t, function (t, r) {
          e(r);
        })
      : t.chartInstance.exportPDF(t, function (t, r) {
          e(r);
        });
  }),
  (OrgChart._exportPDFFromChartsFetchSequentially = function (
    t,
    e,
    r,
    i,
    ...
    if (t >= e.length) {
      var o = [];
      for (var s of e)
        -1 == o.indexOf(s.chartInstance) && o.push(s.chartInstance),
          delete s.chartInstance;
      for (var l of ((r = JSON.stringify(r)), o)) OrgChart.loading.show(l);
      return (
        null == i && (i = "OrgChart.pdf"),
        null == n && (n = !1),
        void OrgChart._ajax(
          l.config.exportUrl + "/v4",
          "POST",
          r,
          "arraybuffer",
          function (t) {
            for (var e of o) OrgChart.loading.hide(e);
            a
              ? a(t)
              : OrgChart._downloadFile("application/pdf", t, i, n, "pdf");
          }
        )
      );
    }
    OrgChart._exportPDFFromChartsFetchWithCallback(e[t], function (o) {
      r.push(o),
        OrgChart._exportPDFFromChartsFetchSequentially(t + 1, e, r, i, n, a);
    });
  }),
  (OrgChart.exportPDFFromCharts = function (t, e, r, i) {
    OrgChart._exportPDFFromChartsFetchSequentially(0, t, [], e, r, i);
  }),
  ...
  (OrgChart.prototype.exportVisio = function (t, e) {
    (t = this._defaultExportOptions(t, "visio")), this._export(t, e);
  }),
  ...
  (OrgChart.prototype._export = function (t, e) {
    var r = this,
      i = {
        ...
        parentLevels: t.parentLevels,
        childLevels: t.childLevels,
        min: t.min,
      };
    t.margin && t.margin[0] < 2 && (t.margin[0] = 2),
      ...
      this._draw(!1, OrgChart.action.exporting, i, function (i, n) {
        var a = document.createElement("div");
        if (((a.innerHTML = i), t.padding > 0)) {
          var o = a.querySelector("svg"),
            s = OrgChart._getViewBox(o);
          (s[0] -= t.padding),
            (s[1] -= t.padding),
            (s[2] += 2 * t.padding),
            (s[3] += 2 * t.padding),
            o.setAttribute("viewBox", s.join()),
            o.setAttribute("width", s[2]),
            o.setAttribute("height", s[3]);
        }
        if ("svg" == t.ext || "vsdx" == t.ext) {
          (o = a.querySelector("svg")).classList.add("boc-" + r.config.mode);
          var l = { content: a.innerHTML, options: t, styles: "" };
          if (!e) {
            var h = OrgChart.events.publish("exportstart", [r, l]);
            if (!1 === h) return !1;
          }
          var c = r.element.querySelector("[data-boc-styles]");
          if (
            (c && (l.styles += c.outerHTML),
            l.styles &&
            ...
            if (e) e(l);
              ...
              if (!1 === (h = OrgChart.events.publish("exportend", [r, l])))
                return !1;
            ...
            OrgChart._ajax(
              r.config.serverUrl + "/Export/Visio",
              "POST",
              d,
              "arraybuffer",
              function (i) {
                if ((OrgChart.loading.hide(r), e)) e(l, i);
                else {
                  if (!1 === OrgChart.events.publish("exportend", [r, i]))
                    return !1;
                  OrgChart._downloadFile(
                    t.mime,
                    i,
          ...
          r._pages(t, a.querySelector("svg"), n, function (i) {
            var n = { content: a.innerHTML, options: t, pages: i, styles: "" },
              o = OrgChart.events.publish("exportstart", [r, n]),
              s = r.element.querySelector("[data-boc-styles]");
            if ((s && (n.styles += s.outerHTML), !1 === o)) return !1;
            e || OrgChart.loading.show(r),
              e
                ? e(r, n, a.querySelector("svg"))
                : ((n = JSON.stringify(n)),
                  OrgChart._ajax(
                    r.config.exportUrl + "/v4",
                    "POST",
                    n,
                    "arraybuffer",
                    function (e) {
  ...
  (OrgChart.prototype._pagesFit = function (t, e) {
    var r = e.getAttribute("width"),
      ...
      n = OrgChart._getViewBox(e),
      a = { w: parseFloat(r), h: parseFloat(i) };
    return [
      {
        vb: n,
        size: {
          w: a.w + (t.margin[1] + t.margin[3]),
          h: a.h + (t.margin[0] + t.margin[2]),
        },
        innerSize: a,
      },
    ];
  ...
  (OrgChart.prototype._pagesAfit = function (t, e, r) {
    ...
    switch (t.format) {
      case "A5":
        (n = OrgChart.A5w), (a = OrgChart.A5h);
        break;
      case "A4":
        (n = OrgChart.A4w), (a = OrgChart.A4h);
        break;
      case "A3":
        (n = OrgChart.A3w), (a = OrgChart.A3h);
        break;
      case "A2":
        (n = OrgChart.A2w), (a = OrgChart.A2h);
        break;
      case "A1":
        (n = OrgChart.A1w), (a = OrgChart.A1h);
        break;
      case "Letter":
        (n = OrgChart.Letterw), (a = OrgChart.Letterh);
        break;
      case "Legal":
        (n = OrgChart.Legalw), (a = OrgChart.Legalh);
    }
    var o = t.landscape
      ...
      s =
        ...
        o / i);
    return this._pagesA100(t, e, 100 * s, r);
  }),
  (OrgChart.prototype._pagesA100 = function (t, e, r, i) {
    var n = OrgChart._getViewBox(e),
      a = 0,
      o = 0;
    switch (t.format) {
      case "A5":
    ...
    var s = n[0],
      ...
      g = { w: t.landscape ? o : a, h: t.landscape ? a : o };
    e.setAttribute("width", d.w), e.setAttribute("height", d.h);
    var p = d.w * (100 / r),
      u = d.h * (100 / r),
      f = s,
      m = l,
    ...
    if (!OrgChart.EXPORT_PAGES_CUT_NODES && "fit" == t.scale) {
      ...
      for (
        var v = Object.keys(i.bordersByRootIdAndLevel),
          O = i.bordersByRootIdAndLevel[v[0]],
          x = Object.keys(O).length,
          y = 1;
        y < v.length;
        y++
      )
        x < Object.keys(i.bordersByRootIdAndLevel[v[y]]).length &&
          ((O = i.bordersByRootIdAndLevel[v[y]]), (x = Object.keys(O).length));
      for (var _ = 0, k = 0; ; ) {
        for (k = _; !(x <= _); ) {
          if ((O[_].maxY - O[_].minY) / (100 / r) > d.h) {
            b = !1;
            break;
          }
          var w = (O[_].minY - O[k].minY) / (100 / r);
          if (
            (_ == x - 1 && (w = (O[_].maxY - O[k].minY) / (100 / r)), w > d.h)
          )
            break;
          _++;
        }
        if (!b) break;
        var S = (_ == x ? O[_ - 1].maxY : O[_ - 1].minY) - O[k].minY;
        if (0 == S) {
          b = !1;
          break;
        }
        if (
          ((I = (I = [f, O[k].minY, p, S]).join()),
          C.push({
            vb: I,
            innerSize: { w: d.x, h: S / (100 / r) - 1 },
            size: g,
          }),
          _ == x)
        )
    ...
    if (!b || OrgChart.EXPORT_PAGES_CUT_NODES || "fit" != t.scale)
      for (
        ...
        for (; m < c + l; ) {
          var I;
          (I = (I = [f, m, p, u]).join()),
            C.push({ vb: I, innerSize: d, size: g }),
            (m += u);
        }
        (f += p), (m = l);
      }
  ...
  (OrgChart.prototype._exportProfile = function (t, e) {
    ...
    switch (t.format) {
      case "A5":
        (i = OrgChart.A5w), (n = OrgChart.A5h);
        break;
      case "A4":
        (i = OrgChart.A4w), (n = OrgChart.A4h);
        break;
      case "A3":
        (i = OrgChart.A3w), (n = OrgChart.A3h);
        break;
      case "A2":
        (i = OrgChart.A2w), (n = OrgChart.A2h);
        break;
      case "A1":
        (i = OrgChart.A1w), (n = OrgChart.A1h);
        break;
      case "Letter":
        (i = OrgChart.Letterw), (n = OrgChart.Letterh);
        break;
      case "Legal":
        (i = OrgChart.Legalw), (n = OrgChart.Legalh);
    }
    var a = {
        w: t.landscape
          ? n - (t.margin[1] + t.margin[3])
      ...
      o = { w: t.landscape ? n : i, h: t.landscape ? i : n },
      s = this.editUI.content(t.nodeId, !0, !0, "100%", !0).element;
    OrgChart.input.init(s);
    var l = {
      content: s.outerHTML,
      options: t,
      pages: [{ vb: "", innerSize: a, size: o }],
      styles: "",
    };
    if (!1 === OrgChart.events.publish("exportstart", [r, l])) return !1;
    e || OrgChart.loading.show(r);
    ...
    if (c)
      for (var d = 0; d < c.children.length; d++)
        "style" == c.children[d].nodeName.toLowerCase() &&
          (l.styles += c.children[d].outerHTML);
    e
      ? e(r, l, s)
      : ((l = JSON.stringify(l)),
        OrgChart._ajax(
          this.config.exportUrl + "/v4",
          "POST",
          l,
          "arraybuffer",
          function (e) {
  ...
  (OrgChart._importSetColumnNames = function (t, e) {
    if (-1 == t.indexOf("id") || -1 == t.indexOf("pid")) {
      ...
      for (u = 0; u < t.length; u++) {
        ...
        v.appendChild(f), b.appendChild(v);
      }
  ...
  (OrgChart.prototype._globalMouseDownHandler = function (t, e) {
    ...
    for (var n = e.target; n != t; ) {
      if (n.hasAttribute(OrgChart.attr.node_id))
        return void this._nodeMouseDownHandler(n, e, r);
      if (n.hasAttribute(OrgChart.attr.control_node_circle_menu_name))
        return (
          e.stopPropagation(),
          e.preventDefault(),
          void this._nodeCircleNodeMenuItemMouseDownHandler(n, e, r)
        );
      n = n.parentNode;
    }
  }),
  (OrgChart.prototype._globalClickHandler = function (t, e) {
    if (
      ...
      if (e.changedTouches.length) {
        var r = {
          ...
          n = this.getScale(),
          a = Math.abs(r.x - this._touch.x) / n,
          o = Math.abs(r.y - this._touch.y) / n;
        if (((this._touch = null), a > i[0] / 10)) return;
        if (o > i[1] / 10) return;
      }
    ...
    for (var s = e.target; s != t; ) {
      if (s.hasAttribute(OrgChart.attr.control_expcoll_id)) {
        var l = s.getAttribute(OrgChart.attr.control_expcoll_id),
          h = this.getNode(l);
        return void this._expCollHandler(h.id);
      }
      if (s.hasAttribute(OrgChart.attr.node_id)) {
        (l = s.getAttribute(OrgChart.attr.node_id)), (h = this.getNode(l));
        return void this._nodeClickHandler(h.id, e);
      }
      if (s.hasAttribute(OrgChart.attr.control_node_menu_id)) {
        e.stopPropagation(), e.preventDefault();
        (l = s.getAttribute(OrgChart.attr.control_node_menu_id)),
          (h = this.getNode(l));
        return void this._nodeMenuClickHandler(h.id, s, e);
      }
      if (s.hasAttribute(OrgChart.attr.control_node_circle_menu_id)) {
        e.stopPropagation(), e.preventDefault();
        l = s.getAttribute(OrgChart.attr.control_node_circle_menu_id);
        return void this._nodeCircleMenuClickHandler(l);
      }
      ...
      if (s.hasAttribute(OrgChart.attr.control_up_id)) {
        l = s.getAttribute(OrgChart.attr.control_up_id);
        return e.stopPropagation(), e.preventDefault(), void this._upHandler(l);
      }
  ...
  (OrgChart.prototype.__mouseScrollHandler = function (t, e) {
    ...
    if (
      ...
      var r = OrgChart._centerPointInPercent(t, e.pageX, e.pageY);
      this.zoom(1 - i, r);
    } else {
      var i = this,
        n = !1,
        ...
        s = 0,
        l = this.getScale();
      r = OrgChart._centerPointInPercent(t, e.pageX, e.pageY);
      var h =
  ...
  (OrgChart.prototype._nodeCircleNodeMenuItemMouseDownHandler = function (
    ...
    var i = t.parentNode.getAttribute(
      ...
      n = t.getAttribute(OrgChart.attr.control_node_circle_menu_name),
      a = this.nodeCircleMenuUI._menu[n];
    if (a.draggable) {
      var o = this,
        s = OrgChart._getClientXY(e),
        l = this.getNode(i);
      t._dragEventFired = !1;
      var h = o.getScale(),
        c = null,
        ...
        O = function (e) {
          if (p) {
            ...
            OrgChart.isMobile() && (i = document.elementFromPoint(r.x, r.y)),
              (r.x += b.x * h),
              (r.y += b.y * h);
            var s = OrgChart._getOffsetXY(o.element, e),
              l = {
                left: o.width() - (s.x + o.config.padding) < 0,
                right: s.x - o.config.padding < 0,
                up: o.height() - (s.y + o.config.padding) < 0,
                down: s.y - o.config.padding < 0,
              };
            if (l.left || l.right || l.up || l.down) {
              ...
              var O = f[4],
                ...
                w = r.x,
                S = r.y;
              o.moveStart(l, function (t) {
                (f[4] = O + t.x),
                  (f[5] = y + t.y),
                  (p.x = _ - t.xWithoutScale),
                  (p.y = k - t.yWithoutScale),
              ...
              if (null != c) {
                ...
                for (
                  var A = o.getNode(c), L = OrgChart.getStParentNodes(A), E = 0;
                  E < L.length;
                  E++
                ) {
              ...
              if (
                ...
                !1 ===
                  OrgChart.events.publish("drag", [
                    o.nodeCircleMenuUI,
                    { from: I, menuItem: a, menuItemName: n },
                  ]) && x(),
                  (t._dragEventFired = !0);
              u.setAttribute("transform", "matrix(" + f.toString() + ")");
            }
        ...
        x = function (e) {
          if (
            ...
            g.classList &&
              ...
              g.classList.remove("boc-cursor-nodrop"),
              g.classList.remove("boc-cursor-copy")),
            g.removeEventListener(r.move, O),
            ...
            return (
              ...
              void (
                ...
                OrgChart.events.publish("drop", [
                  o.nodeCircleMenuUI,
                  { from: l.id, menuItemName: n, menuItem: a, event: e },
                ])
              )
            );
          var i = o.getNode(c);
          OrgChart.events.publish("drop", [
            o.nodeCircleMenuUI,
            { from: l.id, to: i.id, menuItem: a, menuItemName: n, event: e },
          ]),
            v(c, d),
            g.removeChild(u),
            (o._gragStartedId = null);
        };
      g.addEventListener(r.move, O),
  ...
  (OrgChart.prototype._movableHandler = function (t, e, r) {
    ...
    for (
      ...
      var O = this.getNode(a[v]);
      d.push(O), p.push({ x: O.x, y: O.y });
      var x = this.getNodeElement(a[v]);
      if (x) {
        f.push(x);
        var y = OrgChart._getTransform(x);
        u.push({ x: y[4], y: y[5] }), g.push(y);
        var _ = this.element.querySelector(`[data-ctrl-ec-id="${a[v]}"]`);
        if (_) {
          m.push(_);
          var k = OrgChart._getTransform(_);
          C.push(k), b.push({ x: k[4], y: k[5] });
    ...
    var I = { x: c.x, y: c.y },
      ...
      L = function (t, e) {
        if (null != t) {
          e.classList.remove("boc-drag-over");
          for (
            var r = i.getNode(w), n = OrgChart.getStParentNodes(r), a = 0;
            a < n.length;
            a++
          ) {
      ...
      E = function (e) {
        if (I) {
          ...
          if (c.left || c.right || c.up || c.down) {
            ...
            for (var v = [], O = [], x = [], y = [], _ = 0; _ < g.length; _++)
              v.push(g[_][4]),
                O.push(g[_][5]),
                C[_]
                  ? (x.push(C[_][4]), y.push(C[_][5]))
            ...
            if (
              ...
              for (; null != o && o != h; ) {
                if (o.hasAttribute && o.hasAttribute(OrgChart.attr.node_id)) {
                  var R = o.getAttribute(OrgChart.attr.node_id);
                  if (i._gragStartedId && R != i._gragStartedId) {
                    (w = R), (S = o);
                    break;
                  }
                }
            ...
            if (null != w) {
              ...
              for (
                ...
                var F = i.getNodeElement(U[P].id);
                F && (F.style.opacity = 0.1);
              }
              !i.canUpdateLink(d[0].id, w) && h.classList
                ? (h.classList.remove("boc-cursor-grab"),
                  h.classList.remove("boc-cursor-move"),
                  h.classList.remove("boc-cursor-copy"),
            ...
            for (_ = 0; _ < g.length; _++) {
              (g[_][4] = u[_].x + z),
                (g[_][5] = u[_].y + D),
                C[_] && ((C[_][4] = b[_].x + z), (C[_][5] = b[_].y + D)),
                (d[_].x = p[_].x + z),
                (d[_].y = p[_].y + D),
                (d[_].movex = z),
                (d[_].movey = D);
              var H = OrgChart.ui.link(
                d[_],
                i,
                A,
                i.response.bordersByRootIdAndLevel,
      ...
      N = function (e) {
        for (var n = 0; n < d.length; n++) (d[n].x = p[n].x), (d[n].y = p[n].y);
        if (
          (i.moveEnd(),
          h.classList &&
            (h.classList.remove("boc-cursor-grab"),
          ...
          if (
            !1 ===
            (o = OrgChart.events.publish("drop", [i, d[0].id, a.id, f[0], e]))
          )
            return L(w, S), void (i._gragStartedId = null);
          if (i.canUpdateLink(d[0].id, w))
            ((C = i.get(d[0].id)).pid = w),
              (C.stpid = null),
          ...
          if (t._dragEventFired) {
            ...
            if (i.config.movable && !1 !== o)
              if (i.config.movable == OrgChart.movable.detachTree) {
                var c = OrgChart._getTransform(i.getNodeElement(l.id));
                ((C = i.get(l.id)).pid = null),
                  (C.stpid = null),
                  i.updateNode(C, null, !0);
              } else {
                var g = [];
                i.config.movable == OrgChart.movable.node
                  ...
                  : s(l, g);
                var u =
                    (c = OrgChart._getTransform(i.getNodeElement(l.id)))[4] -
                    l.x,
                  m = c[5] - l.y;
        ...
        if (c) {
          ...
          if (C.left || C.right || C.up || C.down) {
            ...
            if (
              ...
              for (; null != i && i != h; ) {
                if (i.hasAttribute && i.hasAttribute(OrgChart.attr.node_id)) {
                  var w = i.getAttribute(OrgChart.attr.node_id);
                  if (l._gragStartedId && w != l._gragStartedId) {
                    (o = w), (s = i);
                    break;
                  }
                }
            ...
            if (("draging" == o && ((o = null), (s = null)), null != o)) {
              s.classList.add("boc-drag-over");
              for (
                var S = l.getNode(o), I = OrgChart.getStParentNodes(S), A = 0;
                A < I.length;
                A++
              ) {
                var L = l.getNodeElement(I[A].id);
            ...
            if (
              ...
              !1 === OrgChart.events.publish("drag", [l, w, e]) && b(),
                (t._dragEventFired = !0);
            f.setAttribute("transform", "matrix(" + d.toString() + ")");
          }
        }
  ...
  (OrgChart.prototype._mouseDownHandler = function (t, e, r) {
    ...
    var n = this.getViewBox(),
      ...
      s = OrgChart._getClientTouchesXY(e, 1),
      l = {
        diffX: 0,
        diffY: 0,
        x0: o.x,
    ...
    e.touches &&
      ...
      ((l.type = "pinch"),
      (l.dist = Math.sqrt(
        (o.x - s.x) * (o.x - s.x) + (o.y - s.y) * (o.y - s.y)
      ))),
      "pan" == l.type &&
        (this._hideBeforeAnimation(), this._changeCursorOnPanStart(n, a, e));
    var h = function (t) {
        ...
        if (l && "pan" == l.type) {
          i._hideBeforeAnimation(),
            (l.diffX = e.x - l.x0),
            (l.diffY = e.y - l.y0);
          var r = -l.diffY / a + l.viewBoxTop,
            o = -l.diffX / a + l.viewBoxLeft;
          i._move(r, o, n);
        } else if (l && "pinch" == l.type) {
          var s = OrgChart._getClientTouchesXY(t, 1),
            h = Math.sqrt(
              (e.x - s.x) * (e.x - s.x) + (e.y - s.y) * (e.y - s.y)
            ),
            c = 1 + (h - l.dist) / (l.dist / 100) / 100;
          l.dist = h;
      ...
      c = function () {
        "pan" == l.type && i.config.sticky
          ...
          "pan" == l.type && i._changeCursorOnPanEnd(),
          (l = null),
  ...
  (OrgChart.manager._setCollpasedProperty = function (t, e, r, i, n, a, o, s) {
    if (
      ...
      n == OrgChart.action.exporting &&
        (null != r.parentLevels || null != r.childLevels) &&
        null != r.id)
    )
      if (null != r.id && (r.parentLevels || r.childLevels)) {
        var l = s[r.id];
      ...
      } else r.expandChildren && (t.collapsed = !1);
  ...
  (OrgChart.manager._iterate = function (t, e, r, i, n, a, o, s, l, h, c, d) {
    ...
    for (b = 0; b < e.children.length; b++)
      OrgChart.manager._iterate(t, e.children[b], r, i, n, a, o, s, l, h, c, d);
  }),
  (OrgChart.manager.__createNodes = function (t, e, r, i, n, a, o, s) {
    ...
    for (c = 0; c < l.length; c++) {
      var C = l[c],
        ...
        v = t[f.stpid],
        O = t[f.pid];
      if ((v || (f.stpid = null), O || (f.pid = null), v)) {
        var x = a ? a[v.id] : null;
        x && (v.min = x.min), v.stChildrenIds.push(f.id);
      } else
        O
          ? (b && ((f.collapsed = b.collapsed), (f.min = b.min)),
  ...
  (OrgChart.manager._createNodes = function (t) {
    ...
    if (i == OrgChart.action.init && e.expand && e.expand.nodes && null == o)
      ...
      for (var O = s[n.id]; O; ) {
        if (
          (b.push(O.id),
          n.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS && O)
        )
          for (c = 0; c < O.childrenIds.length; c++) {
            (D = s[O.childrenIds[c]]).collapsed = !0;
          }
      ...
      O = s[n.id];
      if (n.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
        for (c = 0; c < O.childrenIds.length; c++) {
          (y = s[O.childrenIds[c]]).collapsed = !1;
          for (var x = 0; x < y.childrenIds.length; x++) {
            s[y.childrenIds[x]].collapsed = !0;
          }
        }
      if (
    ...
    var _ = [],
      ...
      I = [];
    for (c = 0; c < l.length; c++)
      OrgChart.manager._iterate(l[c], l[c], s, 0, _, k, w, S, "", b, I, t);
    if (
      ...
      for (c = 0; c < n.ids.length; c++) {
        ...
        else (v = s[n.collapseIds[c]]) && (v.collapsed = !0);
      }
    ...
    for (c = 0; c < I.length; c++) {
      ...
      var A = [],
        ...
        B = [],
        U = [];
      for (x = 0; x < v.children.length; x++) {
        (D = v.children[x]).isAssistant
          ? A.push(D.id)
          : -1 != D.tags.indexOf("right-partner")
          ? ((D.isPartner = 1), (D.children = []), L.push(D.id))
          : -1 != D.tags.indexOf("left-partner")
          ? ((D.isPartner = 2), (D.children = []), E.push(D.id))
          : -1 == D.tags.indexOf("partner") || M % 2
          ? -1 != D.tags.indexOf("partner") && M % 2
            ? ((D.isPartner = 2), (D.children = []), E.push(D.id), M++)
            : D.parentPartner
            ? (N[D.parentPartner.id] || (N[D.parentPartner.id] = []),
              N[D.parentPartner.id].push(D.id))
            : A.push(D.id)
          : ((D.isPartner = 1), (D.children = []), L.push(D.id), M++);
      }
      v.children = [];
      var P = [];
      for (x = 0; x < L.length; x++) {
        N[(D = s[L[x]]).id] ? v.children.push(D) : v.children.splice(0, 0, D);
        for (var F = 0; F < D.childrenIds.length; F++) P.push(D.childrenIds[F]);
      }
      var z = [];
      for (x = 0; x < E.length; x++) {
        N[(D = s[E[x]]).id] ? v.children.push(D) : v.children.splice(0, 0, D);
        for (F = 0; F < D.childrenIds.length; F++) z.push(D.childrenIds[F]);
      }
      ...
      for (x = 0; x < L.length; x++)
        if (N[L[x]])
          for (f = 0; f < N[L[x]].length; f++)
            v.children.push(s[N[L[x]][f]]),
              R++,
              -1 == B.indexOf(L[x]) && B.push(L[x]);
    ...
    for (c = 0; c < w.length; c++) {
      var H = r[(v = s[w[c]]).lcn ? v.lcn : "base"];
      for (x = 0; x < v.subLevels; x++) {
        var $ = new OrgChart.node(
          v.id + "_sub_level_index_" + x,
          v.pid,
          [],
          "subLevel"
        );
        if ((OrgChart.manager._initDinamicNode($, v.lcn), (m = v.parent)))
          (mt = m.children.indexOf(v)) > -1 &&
            (m.children.splice(mt, 1), m.children.splice(mt, 0, $)),
            $.children.push(v),
            ($.parent = m),
            (v.parent = $),
            (s[$.id] = $);
    ...
    for (var j in k) {
      ...
      OrgChart.manager._initDinamicNode($, m.lcn, !0), (s[$.id] = $);
      var q = [];
      for (x = m.children.length - 1; x >= 0; x--) {
        (D = m.children[x]).isAssistant
          ? ((D.parent = null), m.children.splice(x, 1), q.splice(0, 0, D.id))
          : D.isPartner ||
            (D.parent &&
              S[D.parent.id] &&
              $ &&
    ...
    if (Q || et) {
          ...
          for (var j in ((S = {}), ot))
            if (
              ...
              for (c = s[dt].children.length - 1; c >= 0; c--) {
                D = s[dt].children[c];
                ot[j].has(D.id) && s[dt].children.splice(c, 1);
              }
            }
          for (var j in at)
            at[j].length >
      ...
      for (var j in S) {
        ...
        if (0 != (H = r[m.lcn ? m.lcn : "base"]).layout || et) {
          (rt.pnode = m),
            (rt.layout = H.layout),
          ...
          for (var pt = 0; pt < rt.layouts.length; pt++) {
            ...
            for (
              OrgChart.isNEU(ut.subLevels) && (ut.subLevels = 0),
                OrgChart.isNEU(ut.layout) && (ut.layout = H.layout),
                gt = m = s[j];
              gt.isSplit;
            ...
            for (; gt.isSubLevel; ) gt = s[gt.pid];
            var ft = m;
            for (x = 0; x < ut.subLevels; x++) {
              $ = new OrgChart.node(
                pt + "_sublevel_layout_" + x,
                ft.id,
                [],
                "subLevel"
              );
              OrgChart.manager._initDinamicNode($, ft.lcn),
                ($.parent = ft),
                ft.children.push($),
                (s[$.id] = $),
                (ft = $);
            ...
            if (ut.subLevels) {
              for (x = 0; x < ut.childrenIds.length; x++) {
                var mt;
                D = s[ut.childrenIds[x]];
                -1 != (mt = m.children.indexOf(D)) && m.children.splice(mt, 1),
                  (D.parent = ft),
                  ft.children.push(D);
              }
              m = ft;
            ...
            if (
              ...
              for (c = 0; c < ut.childrenIds.length; c += bt) {
                var vt = null;
                for (x = 0; x < bt; x++) {
                  var Ot = c + bt >= ut.childrenIds.length;
                  if (ut.childrenIds.length - 1 < c + x) break;
                  ((D = s[(ct = ut.childrenIds[c + x])]).parent = s[Ct]),
                    s[Ct].children.push(D),
                    Ot ||
                      (bt / 2 - 1 == x &&
                        ((vt = new OrgChart.node(
                          ut.childrenIds[c + x - 1] +
                            "_grid_pseudo_node_" +
                            ut.childrenIds[c + x + 1],
                          Ct,
                          [],
                        ...
                        OrgChart.manager._initDinamicNode(vt, m.lcn),
                        (vt.parent = s[Ct]),
                        s[Ct].children.push(vt),
                        (s[vt.id] = vt)),
                      bt - 1 == x && (Ct = vt.id));
                }
              }
            ...
            if (ut.layout == OrgChart.layout.mixed) {
              var xt = ut.childrenIds;
              for (c = xt.length - 1; c >= 0; c--) {
                (m = (D = s[xt[c]]).parent), (D.layout = OrgChart.layout.mixed);
                for (x = m.children.length - 1; x >= 0; x--)
                  if (D.id == m.children[x].id) {
                    m.children.splice(x, 1);
                    break;
                  }
                if (c > 0) {
              ...
              OrgChart.manager._initDinamicNode($, m.lcn),
                (s[$.id] = $),
                ($.layout = ut.layout);
              var _t = [];
              for (c = ut.childrenIds.length - 1; c >= 0; c--) {
                for (
                  D = s[ut.childrenIds[c]], x = 0;
                  x < m.children.length;
                  x++
                )
                  m.children[x].id == D.id && m.children.splice(x, 1);
                if (
                  ((D.parent = null),
                  (D.layout = ut.layout),
                  ...
                  var kt = new OrgChart.node(
                    pt + "_" + D.id + "_mirror",
                    gt.id,
                    [],
                    "mirror"
                  );
                  OrgChart.manager._initDinamicNode(kt, D.lcn),
                    (kt.layout = ut.layout),
                    (s[kt.id] = kt),
                    _t.splice(0, 0, kt.id);
                }
              ...
              for (V = 1, x = _t.length - 1; x >= 0; x--)
                if (x % 2 && x != _t.length - 1) {
                  G = new OrgChart.node(
                    pt + "_" + m.id + "_split_" + V,
                    gt.id,
                    [],
                  ...
                  OrgChart.manager._initDinamicNode(G, m.lcn),
                    ...
                    _t.splice(x, 0, G.id),
                    V++;
                } else x % 2 && _t.splice(x, 0, $.id);
              for (x = 0; x < _t.length; x += 3) {
                W = null;
                0 == x && (W = m);
                (J = s[_t[x]]), (K = s[_t[x + 1]]), (Z = s[_t[x + 2]]);
                0 != x && (W = s[_t[x - 3]]),
                  0 == x || K || (W = s[_t[x - 2]]),
                  (J.parent = W),
                  W.children.push(J),
  ...
  (OrgChart.manager._getResponse = function (
    ...
    if (
      ((C.top = s - i.padding),
      (C.left = o - i.padding),
      (C.bottom = a + i.padding - e / x),
      (C.right = n + i.padding - t / x),
      (C.maxX = n),
      (C.minX = o),
      (C.maxY = a),
      (C.minY = s),
      ...
      if (y - 2 * i.padding >= n - o)
        switch (((k = (n + o) / 2 - y / 2), i.orientation)) {
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            k = (o - n) / 2 - y / 2;
        }
        ...
        switch (
          ((k = f.x - y / 2 + OrgChart.manager._getNodeWidth(f, i) / 2),
          i.orientation)
        ) {
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            (k = -(y / 2 - (o - n) / 2)) < i.padding - y && (k = i.padding - y);
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.bottom_left:
          case OrgChart.orientation.top_left:
          case OrgChart.orientation.left_top:
            (k = -(y / 2 - (n - o) / 2)) > -i.padding && (k = -i.padding);
        }
      if (_ - 2 * i.padding >= a - s)
        switch (((w = (a + s) / 2 - _ / 2), i.orientation)) {
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            w = (s - a) / 2 - _ / 2;
        }
        ...
        switch (
          ((w = -(_ / 2 - (a - s) / 2)) > -i.padding && (w = -i.padding),
          i.orientation)
        ) {
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            (w = -(_ / 2 - (s - a) / 2)) < i.padding - _ && (w = i.padding - _);
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.right:
            w = f.y - _ / 2 + OrgChart.manager._getNodeWidth(f, i) / 2;
        }
      l = [k, w, y, _];
    } else if (null == l && !u && i.align == OrgChart.ORIENTATION) {
      (y = Math.ceil(t / x)), (_ = Math.ceil(e / x)), (k = 0), (w = 0);
      switch (i.orientation) {
        ...
        case OrgChart.orientation.right:
          ...
          break;
        case OrgChart.orientation.top_left:
          (k = -i.padding), (w = -i.padding);
          break;
        case OrgChart.orientation.right_top:
          (k = i.padding - y), (w = -i.padding);
          break;
        case OrgChart.orientation.left_top:
          (k = -i.padding), (w = -i.padding);
          break;
        case OrgChart.orientation.bottom_left:
          (k = -i.padding), (w = i.padding - _);
      }
      (l = [k, w, y, _]),
        i.sticky &&
          (l[0] < C.left &&
            l[0] < C.right &&
            (l[0] = C.left > C.right ? C.right : C.left),
          l[0] > C.right &&
            l[0] > C.left &&
            (l[0] = C.left > C.right ? C.left : C.right),
          l[1] < C.top &&
            l[1] < C.bottom &&
            (l[1] = C.top > C.bottom ? C.bottom : C.top),
          l[1] > C.bottom &&
            l[1] > C.top &&
            (l[1] = C.top > C.bottom ? C.top : C.bottom));
    }
    if (c == OrgChart.action.centerNode || c == OrgChart.action.maximize) {
      var S = g[d.id];
      1 == d.options.horizontal && (l[0] = S.x + S.w / 2 - l[2] / 2),
        1 == d.options.vertical && (l[1] = S.y + S.h / 2 - l[3] / 2),
        i.sticky &&
          (l[0] < C.left &&
            l[0] < C.right &&
            (l[0] = C.left > C.right ? C.right : C.left),
    ...
    if (
      ...
      if (!OrgChart.FIXED_POSITION_ON_CLICK && I)
        switch (i.orientation) {
          ...
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            A = I.x + I.w - l[2] + i.padding;
            l[0] < A && (l[0] = A);
        }
    }
    for (var L = 0; L < h.length; L++)
      OrgChart.manager._iterate2(h[L], g, i, l, c, d, m, p, r, b, x, t, e);
    return {
      animations: b,
      boundary: C,
      viewBox: l,
  ...
  (OrgChart.manager._setMinMaxXYAdjustifyIterate = function (
    ...
    t.isPartner ? (t.sl = i - 1) : (t.sl = i),
      ...
      t.layout
        ...
        : OrgChart._setMinMaxXY(t, n[e.id][t.sl]),
  ...
  (OrgChart.manager._doNotChangePositionOfClickedNodeIfAny = function (
    ...
    return { x: (l.x ? l.x - h : 0) - s.x, y: (l.y ? l.y - c : 0) - s.y };
  }),
  ...
  (OrgChart.ui = {
    ...
    pointer: function (t, e, r) {
      ...
      var i = OrgChart.t(t.template, !1, r),
        n = i.pointer;
      return n || (n = ""), i.pointer;
    },
    aiButton: function (t) {
      return t.enableAI
    ...
    node: function (t, e, r, i, n, a, o, s, l, h) {
      var c = OrgChart.t(t.templateName, t.min, l),
      ...
      var v = OrgChart._getPosition(r, t, n, a),
        O = "node";
      ...
      return (d =
        ...
        (d += OrgChart.ui.nodeBtns(i, t, s, c, h)) +
        OrgChart.grCloseTag);
    },
    nodeBtns: function (t, e, r, i, n) {
      var a = "";
      return (
        null == t.nodeMenu ||
          e.isSplit ||
    ...
    expandCollapseBtn: function (t, e, r, i, n) {
      var a = "";
      if (i !== OrgChart.action.exporting && !e.isSplit) {
        var o = r[e.lcn ? e.lcn : "base"],
          s = 0,
          l = 0,
          h = OrgChart.t(e.templateName, e.min, n);
    ...
    link: function (t, e, r, i, n, a, o) {
      ...
      if (t.hasPartners) {
        ...
        for (var C = 0; C < t.children.length; C++) {
          (v = t.children[C]).parentPartner
            ? ((m.ppnodes[v.id] = v.parentPartner),
              m.ids.push(v.id),
              1 == v.parentPartner.isPartner
                ? (-1 == m.rightIds.indexOf(v.parentPartner.id) &&
                    m.rightIds.push(v.parentPartner.id),
                  (m.indexes[v.id] = m.rightIds.indexOf(v.parentPartner.id)),
                  m.firstRight || (m.firstRight = v))
                : 2 == v.parentPartner.isPartner &&
                  (-1 == m.leftIds.indexOf(v.parentPartner.id) &&
                    m.leftIds.push(v.parentPartner.id),
                  (m.indexes[v.id] = m.leftIds.indexOf(v.parentPartner.id)),
                  (m.lastLeft = v)))
            : v.isPartner ||
              ((m.lastLeft = v), m.firstRight || (m.firstRight = v));
        }
      ...
      for (C = 0; C < t.children.length; C++) {
        var b,
          ...
          y = (h = OrgChart.t(v.templateName, v.min, r)).link;
        if (v.isChildOfPartner)
          switch (l.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
              var _ = 1 == v.layout ? void 0 : O.minY - (O.minY - f.maxY) / 2;
              x = OrgChart.ui._linkTopToBottom(v.parentPartner, v, h, g, _);
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              _ = 1 == v.layout ? void 0 : O.maxY - (O.maxY - f.minY) / 2;
              x = OrgChart.ui._linkBottomToTop(v.parentPartner, v, h, g, _);
              break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              _ = 1 == v.layout ? void 0 : O.maxX - (O.maxX - f.minX) / 2;
              x = OrgChart.ui._linkRightToLeft(v.parentPartner, v, h, g, _);
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              _ = 1 == v.layout ? void 0 : O.minX - (O.minX - f.maxX) / 2;
              x = OrgChart.ui._linkLeftToRight(v.parentPartner, v, h, g, _);
          }
        else if (m && -1 != m.ids.indexOf(v.id))
          switch (l.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
              x = OrgChart.ui._linkPpTop(m, t, v, O, f, h);
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              x = OrgChart.ui._linkPpBottom(m, t, v, O, f, h);
              break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              x = OrgChart.ui._linkPpRight(m, t, v, O, f, h);
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              x = OrgChart.ui._linkPpLeft(m, t, v, O, f, h);
          }
        else {
          var k =
              v.isAssistant &&
          ...
          if ((k || v.layout > 1) && v.rightNeighbor && v.rightNeighbor.isSplit)
            switch (l.orientation) {
              case OrgChart.orientation.top:
              case OrgChart.orientation.top_left:
              case OrgChart.orientation.bottom:
              case OrgChart.orientation.bottom_left:
                x = OrgChart.ui._linkRightToLeft(v.rightNeighbor, v, h, g);
                break;
              case OrgChart.orientation.right:
              case OrgChart.orientation.right_top:
              case OrgChart.orientation.left:
              case OrgChart.orientation.left_top:
                x = OrgChart.ui._linkBottomToTop(v.rightNeighbor, v, h, g);
            }
          else if (
            (w || v.layout > 1) &&
            v.leftNeighbor &&
            ...
            switch (l.orientation) {
              ...
              case OrgChart.orientation.bottom:
              case OrgChart.orientation.bottom_left:
                x = OrgChart.ui._linkLeftToRight(v.leftNeighbor, v, h, g);
                break;
              case OrgChart.orientation.right:
              case OrgChart.orientation.right_top:
              case OrgChart.orientation.left:
              case OrgChart.orientation.left_top:
                x = OrgChart.ui._linkTopToBottom(v.leftNeighbor, v, h, g);
            }
          else
            switch (l.orientation) {
              case OrgChart.orientation.top:
              case OrgChart.orientation.top_left:
                if (1 == v.isPartner)
                  x = OrgChart.ui._linkLeftToRight(t, v, h, p);
                else if (2 == v.isPartner)
                  x = OrgChart.ui._linkRightToLeft(t, v, h, p);
                else {
                  _ = 1 == v.layout ? void 0 : O.minY - (O.minY - f.maxY) / 2;
                  x = OrgChart.ui._linkTopToBottom(t, v, h, g, _);
                }
                break;
              case OrgChart.orientation.bottom:
              case OrgChart.orientation.bottom_left:
                if (1 == v.isPartner)
                  ...
                  _ = 1 == v.layout ? void 0 : O.maxY - (O.maxY - f.minY) / 2;
                  x = OrgChart.ui._linkBottomToTop(t, v, h, g, _);
                }
                break;
              case OrgChart.orientation.right:
              case OrgChart.orientation.right_top:
                if (1 == v.isPartner)
                  x = OrgChart.ui._linkTopToBottom(t, v, h, p);
                else if (2 == v.isPartner)
                  x = OrgChart.ui._linkBottomToTop(t, v, h, p);
                else {
                  _ = 1 == v.layout ? void 0 : O.maxX - (O.maxX - f.minX) / 2;
                  x = OrgChart.ui._linkRightToLeft(t, v, h, g, _);
                }
                break;
              case OrgChart.orientation.left:
              case OrgChart.orientation.left_top:
                if (1 == v.isPartner)
                  ...
                  _ = 1 == v.layout ? void 0 : O.minX - (O.minX - f.maxX) / 2;
                  x = OrgChart.ui._linkLeftToRight(t, v, h, g, _);
                }
            }
        }
        var S = OrgChart.ui._draggableLinkPath(e, t, v, x, g, l.orientation);
        if (S)
          (b = S),
            (y = y
          ...
          if (
            (x.xa == x.xb && x.xa == x.xc && x.xa == x.xd) ||
            (x.ya == x.yb && x.ya == x.yc && x.ya == x.yd)
          )
            (b = "M" + x.xa + "," + x.ya + " L" + x.xd + "," + x.yd),
              (y = y.replaceAll("{rounded}", b));
          else if (
            Math.abs(x.xa - x.xd) <= OrgChart.LINK_ROUNDED_CORNERS &&
            Math.abs(x.xa - x.xc) <= OrgChart.LINK_ROUNDED_CORNERS &&
            Math.abs(x.xa - x.xb) <= OrgChart.LINK_ROUNDED_CORNERS
          )
            (b = "M" + x.xa + "," + x.ya + " L" + x.xa + "," + x.yd),
              (y = y.replaceAll("{rounded}", b));
          else if (
            Math.abs(x.ya - x.yd) <= OrgChart.LINK_ROUNDED_CORNERS &&
            Math.abs(x.ya - x.yc) <= OrgChart.LINK_ROUNDED_CORNERS &&
            Math.abs(x.ya - x.yb) <= OrgChart.LINK_ROUNDED_CORNERS
          )
            (b = "M" + x.xa + "," + x.ya + " L" + x.xd + "," + x.ya),
              (y = y.replaceAll("{rounded}", b));
          else {
            var I = OrgChart.ui._roundedEdge(
              ...
              A = OrgChart.ui._roundedEdge(x.xb, x.yb, x.xc, x.yc, x.xd, x.yd);
            (b =
              "M" +
              I.x1 +
              "," +
        ...
        var L = { node: t, cnode: v, p: x, html: y, action: a };
        OrgChart.events.publish("render-link", [e, L]),
          c.push(L.html),
          o && d.push({ id: t.id, childId: v.id, html: L.html });
        var E = "";
    ...
    _linkTopToBottom: function (t, e, r, i, n) {
      var a,
        o,
        s,
        l,
      ...
      return (
        ...
        (l = s = e.x + e.w / 2 + r.linkAdjuster.fromX),
    ...
    _linkBottomToTop: function (t, e, r, i, n) {
      var a,
        o,
        s,
        l,
    ...
    _linkRightToLeft: function (t, e, r, i, n) {
      var a,
        o,
        s,
        l,
      ...
      return (
        ...
        (c = l = e.y + e.h / 2 + r.linkAdjuster.fromY),
        (s = o),
        90,
        {
          xa: a,
    ...
    _linkLeftToRight: function (t, e, r, i, n) {
      var a,
        o,
        s,
        l,
  ...
  (OrgChart.wrapText = function (t, e) {
    ...
    if (
      (u.length > 1 &&
        ((n = parseInt(d.split("-")[1])),
        u.length > 2 && "ellipsis" == u[2] && (a = !0)),
      !c)
    )
      return OrgChart._escapeHtml(t);
    if (
    ...
    if (-1 != d.indexOf("multiline")) {
      ...
      var v = document.createElementNS(g, "tspan"),
        O = document.createTextNode(C[0]);
      v.setAttributeNS(null, "x", s),
        v.setAttributeNS(null, "y", l),
        v.setAttributeNS(null, "text-anchor", h),
        v.appendChild(O),
        p.appendChild(v);
      m = 1;
      for (var x = 1, y = !1, _ = 1; _ < C.length; _++) {
        var k = v.firstChild.data.length;
        if (
          ((v.firstChild.data += " " + C[_]), v.getComputedTextLength() > c)
        ) {
          if (
            ...
            if (a && p.children.length == n) {
              var w = p.children[n - 1].textContent;
              (p.children[n - 1].textContent =
                w.substring(0, w.length - 3) + "..."),
                (y = !0);
            }
            break;
          }
          (v = document.createElementNS(g, "tspan")).setAttributeNS(
            null,
            "x",
            s
          ),
            v.setAttributeNS(null, "y", l + b * m),
            v.setAttributeNS(null, "text-anchor", h),
            (O = document.createTextNode(C[_])),
            v.appendChild(O),
            p.appendChild(v),
            m++;
        }
      ...
      return y ? `<title>${OrgChart._escapeHtml(t)}</title>${S}` : S;
    }
  }),
    ...
    if (t.length > 1) {
      ...
      for (var c = 1; c < t.length; c++) {
        ...
        if (
          ...
          var v = n(u, C, 0.5),
            O = n(C, f, 0.5),
            x = ["C", v.x, v.y, O.x, O.y, f.x, f.y];
          (x.origPoint = C), s.push(x);
        } else s.push(g);
      }
      if (h) {
  ...
  (OrgChart.pdfPrevUI.show = function (t, e) {
    ...
    var n,
      a,
      o,
      s = t.element.querySelector("#boc-ppdf-size"),
      l = t.element.querySelector("#boc-ppdf-layout"),
    ...
    (s.value = e.format),
      ...
      OrgChart.pdfPrevUI._showHide(s, l, h),
  ...
  (OrgChart.pdfPrevUI._handler = function (t, e, r) {
    ...
    s.classList.add(t.config.mode),
      (s.innerHTML = r.outerHTML),
      OrgChart._browser().msie &&
        (s.innerHTML = new XMLSerializer().serializeToString(r));
    for (
      var l = s.querySelector("svg"),
      ...
      Object.assign(d.style, {
        ...
        l && l.style.backgroundColor
          ? (d.style.backgroundColor = l.style.backgroundColor)
          : (d.style.backgroundColor = "#fff");
      var g = d.contentWindow.document;
      g.open(),
        (d.style.width = n[c].size.w + "px"),
        (d.style.height = n[c].size.h + "px"),
        (d.style.margin = "10 auto"),
        n[c].backgroundColor &&
          (d.style.backgroundColor = n[c].backgroundColor);
      var p = i.header;
      n[c].header && (p = n[c].header),
        p &&
          (p = p
            .replace("{current-page}", c + 1)
            .replace("{total-pages}", n.length));
      var u = i.footer;
      n[c].footer && (u = n[c].footer),
        u &&
          (u = u
            .replace("{current-page}", c + 1)
            .replace("{total-pages}", n.length)),
    ...
    var v = t.element.querySelector("#boc-ppdf-content");
    OrgChart.animate(
      v,
      { opacity: 0 },
      { opacity: 1 },
  ...
  (OrgChart._exportHtml = function (t, e, r, i, n, a, o, s) {
    for (var l = "", h = 0; h < r.margin.length; h++) l += r.margin[h] + "px ";
    var c =
    ...
    for (var r = "", i = 0; i < this.config.clinks.length; i++) {
      ...
      if (
        ...
        var b = _(d, g, C),
          v = n.template;
        v || (v = "orange");
        var O = OrgChart.clinkTemplates[v];
        if (n.label) {
          var x = OrgChart.clinkLabelPosition(n, d, g, b);
          r += O.label
            .replace("{x}", x.x)
            .replace("{y}", x.y)
            .replace("{val}", n.label);
  ...
  (OrgChart.prototype._slinks = function (t, e) {
    ...
    function a(e, a, o) {
      ...
      if (e.sl == a.sl)
        ...
        switch (g.orientation) {
          case OrgChart.orientation.top:
          case OrgChart.orientation.top_left:
            l.push([f.p, f.q]), l.push([f.r, e.y - u / 3]);
            break;
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
            (f.q = e.y + e.h),
          ...
          if (
            (v.id == a.id
              ...
              : OrgChart._intersects(v, f, g) &&
                ((f = OrgChart._addPoint(v, l, g, f, c)), (b = !0)),
            v.id != a.id)
          ) {
            for (; O; ) {
              if (O.id == a.id) {
              ...
              OrgChart._intersects(O, f, g) &&
                ((f = OrgChart._addPoint(O, l, g, f, c)), (b = !0)),
                (O = O.leftNeighbor);
            }
            for (; x; ) {
              if (x.id == a.id) {
              ...
              OrgChart._intersects(x, f, g) &&
                ((f = OrgChart._addPoint(x, l, g, f, c)), (b = !0)),
                (x = x.rightNeighbor);
            }
          }
          if (!b) {
            ...
            if (v.parent) {
              (u = g.levelSeparation),
                v.parent.layout && (u = g.mixedHierarchyNodesSeparation);
              var k = t.manager.bordersByRootIdAndLevel[C.id][v.parent.sl];
              switch (g.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                  _ = k.maxY + u * (2 / 3);
                ...
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                  (y = k.maxX + u * (2 / 3)), (_ = l[l.length - 1][1]);
                  break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                  (y = k.minX - u * (2 / 3)), (_ = l[l.length - 1][1]);
              }
            }
            l.push([y, _]);
          }
        ...
        switch (
          ...
          case OrgChart.orientation.top:
          case OrgChart.orientation.top_left:
            l.push([h.x + h.w / 2 + p.expandCollapseSize, l[l.length - 1][1]]),
              l.push([l[l.length - 1][0], h.y + h.h]);
            break;
          case OrgChart.orientation.bottom:
          case OrgChart.orientation.bottom_left:
          ...
          case OrgChart.orientation.left:
          case OrgChart.orientation.left_top:
            l.push([l[l.length - 1][0], h.y + h.h / 2 + p.expandCollapseSize]),
              l.push([h.x + h.w, l[l.length - 1][1]]);
            break;
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
      ...
      switch ((p = OrgChart.slinkTemplates[w]).labelPosition) {
        case "start":
          ...
          break;
        case "middle":
          var L = Math.ceil(l.length / 2);
          (S = l[L]),
            (I = l[L - 1]),
            (A = { x: (S[0] + I[0]) / 2, y: (S[1] + I[1]) / 2 });
          break;
        case "end":
          A = { x: l[l.length - 2][0], y: l[l.length - 2][1] };
      }
      o && (l = l.reverse()), l[0].unshift("M");
      for (var E = 1; E < l.length; E++) l[E].unshift("L");
      var N = OrgChart.roundPathCorners(l, OrgChart.LINK_ROUNDED_CORNERS, !1);
      if (s.label) {
        var M = p.label
            .replace("{x}", A.x)
            .replace("{y}", A.y)
    ...
    for (var o = 0; o < this.config.slinks.length; o++) {
      var s = this.config.slinks[o],
        l = t.getNode(s.from),
        h = t.getNode(s.to);
      l &&
        h &&
        -1 != e.res.visibleNodeIds.indexOf(h.id) &&
        -1 != e.res.visibleNodeIds.indexOf(l.id) &&
        (l.sl >= h.sl ? a(l, h, !1) : a(h, l, !0));
    }
    e.content += r;
  }),
  ...
  (OrgChart._ai.prototype.toolCalls = function (t, e) {
    ...
    var n = [],
      ...
      d = null,
      g = null;
    for (var p of i.toolCalls)
      null == p.FunctionResult &&
        ("removeNode" == p.FunctionName
          ? n.push(p)
          : "addNode" == p.FunctionName
          ? a.push(p)
          : "updateNode" == p.FunctionName
          ? o.push(p)
          : "select" == p.FunctionName
          ? s.push(p)
          : "deselect" == p.FunctionName
          ? l.push(p)
          : "exportPDF" == p.FunctionName
          ? (h = p)
          : "changeTemplate" == p.FunctionName
          ? (c = p)
          : "addSlink" == p.FunctionName
          ? (d = p)
          : "removeSlink" == p.FunctionName && (g = p));
    var u = !1;
    if (
      (c &&
        ((u = !0),
        (p.FunctionResult = "ok"),
        (this.instance.config.template = p.FunctionArguments.templateName)),
      d)
    ) {
      var f = this.instance.getNode(p.FunctionArguments.employeeId1),
        m = this.instance.getNode(p.FunctionArguments.employeeId2);
      f && m && f != m
        ? ((u = !0),
          this.instance.addSlink(f.id, m.id),
          (p.FunctionResult = "ok"))
        : (p.FunctionResult = `Cannot add link between ${p.FunctionArguments.employeeId1} and ${p.FunctionArguments.employeeId2}`);
    }
    if (g) {
      (f = this.instance.getNode(p.FunctionArguments.employeeId1)),
        (m = this.instance.getNode(p.FunctionArguments.employeeId2));
      f && m && f != m
        ? ((u = !0),
          this.instance.removeSlink(f.id, m.id),
          (p.FunctionResult = "ok"))
        : (p.FunctionResult = `Cannot remove link between ${p.FunctionArguments.employeeId1} and ${p.FunctionArguments.employeeId2}`);
    }
    for (var p of n)
      (u = !0),
        (p.FunctionResult = "ok"),
        this.instance.remove(p.FunctionArguments.id);
    for (var p of a) {
      (u = !0),
        (p.FunctionResult = "ok"),
        (C = JSON.parse(JSON.stringify(p.FunctionArguments))).isAssistant &&
          (C.tags = ["assistant"]),
        delete C.isAssistant,
        OrgChart.isNEU(C.id) && (C.id = this.instance.generateId()),
        this.instance.add(C);
    }
    for (var p of o) {
      (u = !0), (p.FunctionResult = "ok");
      var C = this.instance.get(p.FunctionArguments.id);
      for (var b in p.FunctionArguments)
        "id" != b &&
          null != p.FunctionArguments[b] &&
          (C[b] = p.FunctionArguments[b]);
      this.instance.update(C);
    }
    for (var p of s)
      for (var v of ((p.FunctionResult = "ok"), p.FunctionArguments.ids)) {
        var O = p.FunctionArguments.color;
        O || (O = "#FFCA28");
        var x = this.instance.getNodeElement(v).firstChild;
        x &&
          ((x.style.stroke = p.FunctionArguments.color),
    ...
    u
      ? (this.setContext(),
        this.instance.draw(OrgChart.action.update, void 0, y))
      : y();
    var _ = function () {
      var t = [];
    ...
    h
      ? OrgChart.exportPDFFromCharts(
          [{ format: "A4", chartInstance: this.instance }],
          void 0,
          void 0,
          function (t) {
            (p.FunctionResult = "ok"),
  ...
  (OrgChart.aiUI.prototype._create = function () {
    if (!this.element) {
      ...
      var r = this.instance.element.querySelector("[data-boc-ai-close] svg");
      r &&
  ...
  (function (t, e) {
    ...
    const a = {
      ...
      A = n(I, "u").replace(/punct/g, y).getRegex(),
      L = n(I, "u").replace(/punct/g, S).getRegex(),
      E =
        "^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",
      N = n(E, "gu")
        .replace(/notPunctSpace/g, k)
        .replace(/punctSpace/g, _)
        .replace(/punct/g, y)
        .getRegex(),
      M = n(E, "gu")
      ...
      Y = {
        ...q,
        br: n(x).replace("{2,}", "*").getRegex(),
        text: n(q.text)
          .replace("\\b_", "\\b_| {2,}\\n")
          .replace(/\{2,\}/g, "*")
          .getRegex(),
      },
      X = { normal: C, gfm: v, pedantic: O },
      V = { normal: $, gfm: q, breaks: Y, pedantic: j },
      G = {
        "&": "&amp;",
        "<": "&lt;",
        ">": "&gt;",
    ...
    class it {
      ...
      link({ href: t, title: e, tokens: r }) {
        ...
        if (null === n) return i;
        let a = '<a href="' + (t = n) + '"';
        return e && (a += ' title="' + J(e) + '"'), (a += ">" + i + "</a>"), a;
      }
      image({ href: t, title: e, text: r }) {
        const i = K(t);
        if (null === i) return J(r);
        let n = `<img src="${(t = i)}" alt="${r}"`;
        return e && (n += ` title="${J(e)}"`), (n += ">"), n;
      }
      text(t) {
  ...
  OrgChart.events.on("renderbuttons", function (t, e) {
    if (e.node && e.node.tags && e.node.tags.has("group-dotted-lines")) {
      ...
      if (-1 != n.indexOf("{collapsed-children-count}")) {
        var o = OrgChart.collapsedChildrenCount(t, a);
        n = n.replace("{collapsed-children-count}", o);
      }
      if (-1 != n.indexOf("{collapsed-children-total-count}")) {
        var s = OrgChart.collapsedChildrenTotalCount(t, a);
        n = n.replace("{collapsed-children-total-count}", s);
      }
      if (-1 != n.indexOf("{children-count}")) {
        var l = OrgChart.childrenCount(t, a);
        n = n.replace("{children-count}", l);
      }
      if (-1 != n.indexOf("{children-total-count}")) {
        var h = OrgChart.childrenTotalCount(t, a);
        n = n.replace("{children-total-count}", h);
      }
      e.html += n;
    }
  }),
  OrgChart.events.on("redraw", function (t, e) {
    if (t.config.groupDottedLines.length) {
      ...
      var n = t.element.querySelectorAll("[data-ctrl-n-dotted-open]");
  ...
  (OrgChart.miniMap._init = function (t) {
    if (!t.element.querySelector('[data-id="mini-map"]')) {
      ...
      t._addEvent(i, "DOMMouseScroll", l), t._addEvent(i, "mousewheel", l);
      var h = 0,
        c = 0,
        d = function (t) {
          OrgChart.miniMap._mouseMove = !0;
  ...
  (OrgChart._search.searchAndComputeScore = function (t, e, r, i) {
    ...
    var n = e.toLowerCase(),
      a = OrgChart._search.searchIndexesOf(n, t);
    ...
    var v = e;
    for (p = a.length - 1; p >= 0; p--)
      v = (v = v.insert(a[p].start + a[p].length, "</mark>")).insert(
        a[p].start,
        "<mark>"
      );
    return { __searchMarks: v, __score: b };
  }),
  ...
  (OrgChart.input.validateAndGetData = function (t) {
    ...
    if (!r) return !1;
    var a = t.querySelectorAll("[data-binding]"),
      o = {};
    for (i = 0; i < a.length; i++) {
      var s = a[i],
        l = s.getAttribute("data-binding");
      if ("checkbox" == s.type.toLowerCase()) o[l] = s.checked;
      else if (s.selectedOptions && s.hasAttribute("multiple")) {
        var h = s.selectedOptions;
        o[l] = Array.from(h).map(({ value: t }) => t);
      } else o[l] = s.value;
    }
    return o;
  }),
